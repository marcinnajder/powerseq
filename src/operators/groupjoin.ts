...
declare module '../enumerable' {
    interface Enumerable<T> {
        groupjoin<T2,TKey,TResult>(source2: Iterable<T2>, key1Selector:keySelector<T,TKey>,
            key2Selector:keySelector<T2,TKey>, resultSelector:(item1:T, item2: Enumerable<T2>) => TResult) : Enumerable<TResult>;
    }
}
Enumerable.prototype.groupjoin = function<T,T2,TKey,TResult>(this:Enumerable<T>,source2: Iterable<T2>, key1Selector:keySelector<T,TKey>,
    key2Selector:keySelector<T2,TKey>, resultSelector:(item1:T, item2: Enumerable<T2>) => TResult) : Enumerable<TResult>{
