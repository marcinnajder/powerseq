...
function _orderbydescending<T>(source: Iterable<T>, keySelector: Selector<T, any>): OrderedIterable<T> {
...
export function orderbydescending<T>(source: Iterable<T>, keySelector: Selector<T, any>): OrderedIterable<T>;
export function orderbydescending<T>(keySelector: Selector<T, any>): OperatorR<T, OrderedIterable<T>>;
