import { OperatorR, Operator, Func } from "./common/types";
...
export function pipe<T1, T2>(a: T1, f1: Func<T1, T2>): T2;
export function pipe<T1, T2, T3>(a: T1, f1: Func<T1, T2>, f2: Func<T2, T3>): T3;
export function pipe<T1, T2, T3, T4>(a: T1, f1: Func<T1, T2>, f2: Func<T2, T3>, f3: Func<T3, T4>): T4;
export function pipe<T1, T2, T3, T4, T5>(a: T1, f1: Func<T1, T2>, f2: Func<T2, T3>, f3: Func<T3, T4>, f4: Func<T4, T5>): T5;
export function pipe<T1, T2, T3, T4, T5, T6>(a: T1, f1: Func<T1, T2>, f2: Func<T2, T3>, f3: Func<T3, T4>, f4: Func<T4, T5>, f5: Func<T5, T6>): T6;
export function pipe<T1, T2, T3, T4, T5, T6, T7>(a: T1, f1: Func<T1, T2>, f2: Func<T2, T3>, f3: Func<T3, T4>, f4: Func<T4, T5>, f5: Func<T5, T6>, f6: Func<T6, T7>): T7;
export function pipe<T1, T2, T3, T4, T5, T6, T7, T8>(a: T1, f1: Func<T1, T2>, f2: Func<T2, T3>, f3: Func<T3, T4>, f4: Func<T4, T5>, f5: Func<T5, T6>, f6: Func<T6, T7>, f7: Func<T7, T8>): T8;
export function pipe<T1, T2, T3, T4, T5, T6, T7, T8, T9>(a: T1, f1: Func<T1, T2>, f2: Func<T2, T3>, f3: Func<T3, T4>, f4: Func<T4, T5>, f5: Func<T5, T6>, f6: Func<T6, T7>, f7: Func<T7, T8>, f8: Func<T8, T9>): T9;
